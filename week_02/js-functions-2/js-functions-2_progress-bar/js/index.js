...
function calculateScrollPercentage() {
  let windowScroolY = window.scrollY;
  let windowInnerHeight = window.innerHeight;
  let documentbodyclientHeight = document.body.clientHeight;

  console.log(windowScroolY);
  console.log(windowInnerHeight);
  console.log(documentbodyclientHeight);

  let clienScroll = Math.round(
    windowScroolY / (windowInnerHeight - documentbodyclientHeight)
  );
  return clienScroll;
}
