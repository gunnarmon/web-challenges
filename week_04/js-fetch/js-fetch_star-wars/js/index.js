...
async function fetchDataAndRender() {
  ...
  //store the results of the fetched data array in a variable:
  const starWarsPeople = data.results;

  console.dir(starWarsPeople);

  //iterate with forEach over the fetched and stored data and create anew Card for each 'character':
