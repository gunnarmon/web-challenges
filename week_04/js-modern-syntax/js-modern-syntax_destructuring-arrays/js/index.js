...
console.log("Last name: ", lastNameOfChris);
console.log("Age: ", ageOfChris);
...
console.log("Last Name: ", lastNameOfAlex);
...
export const result = add(...allValues); // Spread values inside this function call
